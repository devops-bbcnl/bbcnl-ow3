...
const handleSubscribe = async (e: React.FormEvent) => {
  ...
  const socialLinks = [
    ...
    { name: 'Instagram', icon: <FaInstagram className="w-5 h-5" />, href: 'https://www.instagram.com/bbcngl01/' },
    { name: 'LinkedIn', icon: <FaLinkedin className="w-5 h-5" />, href: 'https://www.linkedin.com/company/108617057/admin/dashboard/' },
  ];
