                  ...
                  >
                    {isSubmitting ? (
                      <span className="flex items-center justify-center">
                        <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-[#ffd700]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            >
              <div>
                ...
                <p className="text-gray-400 mb-8">
                  Have questions or want to discuss a project? Reach out to us using the information below or fill out the contact form.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:contact@bubblebarrel.dev" className="text-gray-400 hover:text-[#ffd700] transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="tel:+1234567890" className="text-gray-400 hover:text-[#ffd700] transition-colors">
                      +234 8037674195
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-400">
                      7th Avenue Federal Housing Estate<br />
                      Egbeada-Irete, Owerri<br />
                      Imo State, Nigeria
                    </p>
                  </div>
                </div>
