...
// Get the LoadRunner Logistics brand data
const brand = brands.find(brand => brand.id === 4);

// Screenshots configuration for LoadRunner Logistics
...
export default function LoadRunnerLogisticsPage() {
  if (!brand) {
